...
public class HttpUtil {
     ...
     * @param urlStr 地址
     * @param data  json数据
     * @param contentType 内容类型：application/json
     * @param token  授权 Authorization 可为null
     * @return
     */
    public static String postData(String urlStr, String data, String contentType, String token) {
    ...
    public static String postHttp(String url, Map<String, String> map) {
        ...
        try {
            ...
            //设置参数为json方式提交 "Content-Type","application/json"
